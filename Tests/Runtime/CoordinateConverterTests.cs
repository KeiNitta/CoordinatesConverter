...
namespace ntk.GeospatialCoordinates.Tests
{
    public class CoordinateConverterTests
    {
        ...
        [Test]
        public void JapanPlaneRectangular_ZoneOriginIsZeroAndHeightIsAbsolute()
        {
        ...
        public void JapanPlaneRectangular_TokyoDatumBesselAgreesWithGsiReference()
        {
            ...
            var converter = new CoordinateConverter(new GpsCoordinate(36d, 139d + 50d / 60d), CoordinateTransformationMode.JapanPlaneRectangular, JapanPlaneRectangularZone.IX, JapanPlaneRectangularDatum.TokyoDatumBessel);
            var result = converter.ToUnity(coordinate);
